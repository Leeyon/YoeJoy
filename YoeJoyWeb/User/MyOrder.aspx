        ...
        <table width="100%" border="0" cellspacing="5" cellpadding="5">
            ...
            <tr>
                <td style="padding-left: 30px; padding-right: 20px;">
                    <ul>
                        <li>1) 您来电要求作废订单</li>
                        <li>2) 由于您的订单重复、地址不详等原因，MMMbuy.cn 员工将您的订单作废</li>
                    ...
                    <ul style="background: white; padding: 20px; margin-top: 10px;">
                        ...
                        <li>b. 网上支付订单：保留三个工作日（以订单生成时间算起，三个工作日后如我们还未收到您的货款，系统将自动作废您的订单）</li>
                        <li>c. 邮局汇款、银行电汇订单：保留七个工作日（以订单生成时间算起，七个工作日后如我们还未收到您的货款，系统将自动作废您的订单）</li>
                        <li><strong>若还有其他疑问，欢迎您致电 400 688 4220 垂询或给我们发送电子邮件。我们的电子邮件地址是：</strong> <a href="mailto:service@mmbuy.cn">
                            <font color="blue"><strong>service@mmbuy.cn</strong></font></a></li>
                    </ul>
                </td>
            </tr>
            <tr>
